...
img2 = cv2.imread('data/temple/temple/temple0277.png', cv2.IMREAD_GRAYSCALE)
...
# 保存匹配结果图像
cv2.imwrite('1&277.png', img_matches)

# 使用 matplotlib 显示匹配结果
plt.figure(figsize=(10, 5))
plt.imshow(img_matches)
plt.title('1&277 Feature Matches')
plt.axis('off')
plt.show()
